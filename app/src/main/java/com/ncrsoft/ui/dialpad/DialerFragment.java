...
package com.ncrsoft.ui.dialpad;
...
import com.ncrsoft.api.ISipService;
...
import com.ncrsoft.models.Filter;
import com.ncrsoft.ui.SipHome.ViewPagerVisibilityListener;
import com.ncrsoft.ui.dialpad.DialerLayout.OnAutoCompleteListVisibilityChangedListener;
import com.ncrsoft.utils.CallHandlerPlugin;
import com.ncrsoft.utils.CallHandlerPlugin.OnLoadListener;
import com.ncrsoft.utils.DialingFeedback;
import com.ncrsoft.utils.Log;
import com.ncrsoft.utils.PreferencesWrapper;
import com.ncrsoft.utils.Theme;
import com.ncrsoft.utils.contacts.ContactsSearchAdapter;
import com.ncrsoft.widgets.AccountChooserButton;
import com.ncrsoft.widgets.AccountChooserButton.OnAccountChangeListener;
import com.ncrsoft.widgets.DialerCallBar;
import com.ncrsoft.widgets.DialerCallBar.OnDialActionListener;
import com.ncrsoft.widgets.Dialpad;
import com.ncrsoft.widgets.Dialpad.OnDialKeyListener;
    ...
    public void placeVMCall() {
        ...
        if (accountToUse >= 0) {
            ...
            if (!TextUtils.isEmpty(vmAcc.vm_nbr)) {
                ...
                (new ComponentName(getActivity(), com.ncrsoft.plugins.telephony.CallHandler.class).flattenToString()))) {
            // Case gsm voice mail
