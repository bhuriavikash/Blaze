...
import com.ncrsoft.ui.outgoingcall.OutgoingCallChooser;
		...
		if (action.equals(Intent.ACTION_NEW_OUTGOING_CALL) ) {
			...
			if(prefsWrapper.isValidConnectionForOutgoing() || potentialHandlers.size() > 1) {
	            ...
	            if(gsmCallHandlerId == null) {
	                gsmCallHandlerId = CallHandlerPlugin.getAccountIdForCallHandler(aContext, (new ComponentName(aContext, com.ncrsoft.plugins.telephony.CallHandler.class)).flattenToString());
	            }
