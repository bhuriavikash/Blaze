...
package com.ncrsoft.wizards.utils;
    ...
    public static AccountCreationWebviewHelper getInstance() {
        if(instance == null) {
            if(Compatibility.isCompatible(8)) {
                instance = new com.ncrsoft.wizards.utils.AccountCreationWebviewHelper8();
            }else {
                instance = new com.ncrsoft.wizards.utils.AccountCreationWebviewHelper3();
            }
        }
