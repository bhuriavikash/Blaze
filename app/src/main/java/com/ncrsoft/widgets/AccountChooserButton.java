...
import com.ncrsoft.utils.AccountListUtils;
import com.ncrsoft.utils.AccountListUtils.AccountStatusDisplay;
...
public class AccountChooserButton extends LinearLayout implements OnClickListener, View_HasStateListenerSupport {
    ...
    public AccountChooserButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        telCmp = new ComponentName(getContext(), com.ncrsoft.plugins.telephony.CallHandler.class);
