...
package com.ncrsoft.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, com.ncrsoft.widgets.contactbadge.QuickContactBadge topBadge) {
