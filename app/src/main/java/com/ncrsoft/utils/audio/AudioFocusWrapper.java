...
package com.ncrsoft.utils.audio;
    ...
    public static AudioFocusWrapper getInstance() {
        if (instance == null) {
            if (Compatibility.isCompatible(17)) {
                instance = new com.ncrsoft.utils.audio.AudioFocus17();
            } else if (Compatibility.isCompatible(8)) {
                instance = new com.ncrsoft.utils.audio.AudioFocus8();
            } else {
                instance = new com.ncrsoft.utils.audio.AudioFocus3();
            }
        }
