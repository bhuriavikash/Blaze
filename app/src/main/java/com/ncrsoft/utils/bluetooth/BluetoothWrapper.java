...
package com.ncrsoft.utils.bluetooth;
	...
	public static BluetoothWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(14)) {
		        instance = new com.ncrsoft.utils.bluetooth.BluetoothUtils14();
		    }else if(Compatibility.isCompatible(8)) {
                instance = new com.ncrsoft.utils.bluetooth.BluetoothUtils8();
			}else {
                instance = new com.ncrsoft.utils.bluetooth.BluetoothUtils3();
			}
		    if(instance != null) {
